INSERT OR REPLACE INTO yin_yang (id, name) VALUES
(1, '陽'),
(2, '陰');

INSERT OR REPLACE INTO five_elements (id, name, generating_cycle, controlling_cycle) VALUES
(1, '水二局', '金生水', '水剋火'),
(2, '火六局', '木生火', '火剋金'),
(3, '土五局', '火生土', '土剋水'),
(4, '木三局', '水生木', '木剋土'),
...
INSERT OR REPLACE INTO palaces (id, name, position) VALUES
(1, '命宮', 1),
(2, '父母宮', 2),
(3, '福德宮', 3),
(4, '田宅宮', 4),
...
INSERT OR REPLACE INTO star_categories (id, name) VALUES
(1, '十四主星'),
(2, '七吉星'),
(3, '四化星'),
(4, '六煞星'),
...
INSERT OR REPLACE INTO heavenly_stems_earthly_branches (id, stem_name, branch_name, yin_yang_id, element_id) VALUES
(1, '甲', '子', 1, 4),
(2, '乙', '丑', 2, 3),
(3, '丙', '寅', 1, 2),
(4, '丁', '卯', 2, 4),
...
INSERT OR REPLACE INTO zodiac_signs (id, name, earthly_branch_id) VALUES
(1, '鼠', 1),
(2, '牛', 2),
(3, '虎', 3),
(4, '兔', 4),
...
(11, '狗', 11),
(12, '豬', 12);
INSERT OR REPLACE INTO stars (id, name, category_id, strength_level) VALUES
(1, '紫微', 1, 10),
(2, '天機', 1, 8),
(3, '太陽', 1, 9),
(4, '武曲', 1, 9),
...
(5, 'female', 41, 50);
-- 14主星排列規則 (Star_A14)
INSERT OR REPLACE INTO star_placement_rules (star_id, palace_id, condition_type, condition_value) VALUES
...
(32, 5, 'earthly_branch', '巳');

-- 五行局星曜排列表 (FiveEleTable)

-- 五行相生相剋關係 (FiveEleArr)
INSERT OR REPLACE INTO five_elements_age_limits (element_id, gender, start_age, end_age) VALUES
...
INSERT OR REPLACE INTO five_elements_star_tables (element_id, sequence_data) VALUES
...
INSERT OR REPLACE INTO destiny_palace_rules (gender, heavenly_stem, earthly_branch, destiny_palace_position) VALUES
('male', '甲', '子', 1),
('female', '甲', '子', 7),
('male', '乙', '丑', 2),
('female', '乙', '丑', 8);

INSERT OR REPLACE INTO analysis_items (id, code, name, description) VALUES
